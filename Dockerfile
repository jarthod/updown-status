...
ARG DEV_PACKAGES="git build-essential libpq-dev wget vim curl gzip xz-utils libsqlite3-dev zlib1g-dev"
...
COPY Gemfile* ./
RUN USE_FREEDESKTOP_PLACEHOLDER=true bundle install &&  rm -rf vendor/bundle/ruby/*/cache
